import type { MigrationDonutChartDatum } from "../charts/MigrationDonutChart.js";
...
export const buildHostPowerStateChart = (
  ...
  for (const [key, count] of Object.entries(hostPowerStates ?? {})) {
...
export const buildVmPowerStateChart = (
  ...
  for (const [key, count] of Object.entries(powerStates ?? {})) {
