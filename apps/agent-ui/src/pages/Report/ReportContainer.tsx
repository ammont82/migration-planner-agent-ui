...
export const ReportContainer: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchVMs = async () => {
      try {
        ...
        const filterParams = {
          ...
          diskSizeMin: filters.diskSizeMin,
          diskSizeMax: filters.diskSizeMax,
          memorySizeMin: filters.memorySizeMin,
          memorySizeMax: filters.memorySizeMax,
          status: filters.statuses, // Note: backend uses 'status' not 'statuses'
        };
    ...
    fetchVMs();
  }, [activeTab, agentApi, searchParams]);
  ...
  const handleTabSelect = (
    ...
    if (tabIndex === 1) {
      ...
      newParams.delete("minIssues");
      newParams.delete("diskSizeMin");
      newParams.delete("diskSizeMax");
      newParams.delete("memorySizeMin");
      newParams.delete("memorySizeMax");
    }
    setSearchParams(newParams, { replace: true });
  };
